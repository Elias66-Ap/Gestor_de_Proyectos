        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item mb-2">
                <a href="{{ route('admin.inicio') }}"
                    class="nav-link d-flex align-items-center {{ request()->routeIs('admin.inicio') ? 'active' : '' }}">
                    <i class="bi bi-house-door me-2"></i> Inicio
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="{{ route('admin.colaboradores') }}"
                    class="nav-link d-flex align-items-center {{ request()->routeIs('admin.colaboradores*') ? 'active' : '' }}">
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('admin.proyecto') }}"
                    class="nav-link d-flex align-items-center {{ request()->routeIs('admin.proyecto') ? 'active' : '' }}">
                    <i class="bi bi-folder me-2"></i> Proyectos
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="{{ route('admin.notificacion') }}"
                    class="nav-link d-flex align-items-center {{ request()->routeIs('admin.notificacion') ? 'active' : '' }}">
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('admin.perfil') }}"
                    class="nav-link d-flex align-items-center {{ request()->routeIs('admin.perfil') ? 'active' : '' }}">
